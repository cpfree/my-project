...
//import com.github.codedict.dynamic.DictCacheIoHandle;
...
//        return RedisUtils.doQueryHashData(RedisCacheKey.CacheKey.dictType, DictTypeBean::getTypeKey, null);
//    }
//
//    @Override
//    public DictTypeBean readOneFromCache(String fieldKey) {
//        final Map<String, DictTypeBean> map = RedisUtils.doQueryHashData(RedisCacheKey.CacheKey.dictType, DictTypeBean::getTypeKey, Arrays.asList(fieldKey));
...
//        map.put(data.getTypeKey(), data);
//        RedisUtils.doPushHashData(RedisCacheKey.CacheKey.dictType, map);
//    }
//
//    @Override
//    public void doWriteOneToCache(DictTypeBean data) {
//    }
//
//    /**
//     * 判断redis里面数据是否存在
